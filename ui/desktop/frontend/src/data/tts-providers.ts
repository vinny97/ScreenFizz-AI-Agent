 ...
 * Desktop mirror of ui/web/src/data/tts-providers.ts
 *
 * REMOVED: models, voices, dynamic, defaultVoice, defaultModel, requiresApiKey.
 *   - Models/voices/params come from GET /v1/tts/capabilities.
 *   - requiresApiKey derived from capabilities.requires_api_key.
 *
 * KEPT: TtsProviderId union type for type narrowing; id, title, color, desc.
 *
...
/**
 * Synchronous model catalog fallback for consumers that cannot await capabilities.
 * Kept in sync with backend allowlists.
 */
