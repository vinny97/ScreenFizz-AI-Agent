/**
 * Pure logic helpers for DynamicParamForm — desktop mirror.
 * Mirrors ui/web/src/components/dynamic-param-form-logic.ts
 ...
 * Keys are stored flat (dot-notation preserved as-is) — matches backend wire format.
 */
 ...
 * Key may be dot-notation (e.g. "voice_settings.stability"); stored flat as-is.
 */
