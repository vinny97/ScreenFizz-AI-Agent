...
export function ScreenFizzPage() {
  ...
  return <div className="space-y-6 p-4 sm:p-6">
    ...
    <Tabs defaultValue="review">
      ...
      <TabsContent value="overview" className="space-y-4"><div className="grid grid-cols-2 gap-3 lg:grid-cols-6">{stat("Businesses Found","businesses_found")}{stat("Prospects","prospects")}{stat("Pending Review","pending_review")}{stat("Approved","approved")}{stat("Sent","sent")}{stat("Replies","replies")}</div></TabsContent>
